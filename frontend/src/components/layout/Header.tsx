...
export default function Header() {
  ...
  return (
    <header className="border-b border-[#D7E3F7] bg-[linear-gradient(90deg,rgba(255,255,255,0.92)_0%,rgba(234,243,255,0.92)_50%,rgba(255,255,255,0.92)_100%)] backdrop-blur-md">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `btn-outline rounded-full ${
                  isActive ? "border-[#0043A8] bg-[#EAF3FF] text-[#0043A8]" : ""
                }`
              }
            >
              Mijn account
          ...
          {user && (
            <div className="relative" ref={notificationMenuRef}>
              <button
                ...
                className="relative inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-700 transition hover:border-[#0043A8] hover:bg-[#EAF3FF] hover:text-[#0043A8]"
              ...
              {isNotificationsOpen && (
                <div
                  ...
                  role="menu"
                  aria-label="Meldingen"
                  className="absolute right-0 z-50 mt-2 w-80 rounded-xl border border-slate-200 bg-white p-3 shadow-lg"
                >
